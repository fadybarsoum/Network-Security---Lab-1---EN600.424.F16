...
set prog "xml2rfc"
set prog_version "v1.35dev"
set prog_url "http://xml2rfc.ietf.org/"
set prog_ack \
...
"This document specifies an Playground Best Current Practices for the Playground
Experiment, and requests discussion and suggestions for improvements.
Distribution of this memo is unlimited."}

               {info     "Informational" FYI
"This memo provides information for the Playground Experiment.
It does not specify an Playground standard of any kind.
Distribution of this memo is unlimited."}

               {exp      "Experimental" EXP
"This memo defines an Experimental Protocol for the Playground Experiment.
It does not specify a Playground standard of any kind.
Discussion and suggestions for improvement are requested.
Distribution of this memo is unlimited."}

               {historic "Historic" ""
"This memo describes a historic protocol for the Playground Experiment.
It does not specify a Playground standard of any kind.
Distribution of this memo is unlimited."} }
...
than English."}
		...
		{playgroundSpring201604
"This Playground-Draft is submitted for pedagogical purposes.
...
under copyright, their inclusion here falls under Fair Use provisions.
Outside of PLAYGROUND contexts, this document may not be copied
...
proc begin {name {av {}} } {
    ...
    if {$passno == 1} {
        ...
        switch -- [set type $name] {
			...
			# REMOVED BY SETH NIELSON. Playground Drafts do not use this IPR
...
set copylong1 {
"Copyright &copy; Seth James Nielson (%YEAR%). All Rights Reserved."
...
associated organizations, except by explicit permission."
...
set copylong2 {
"Copyright &copy; Seth James Nielson (%YEAR%)."
...
currently in use without permission."
...
proc pass2begin_rfc {elemX} {
    ...
    global copyshort copyshort1 copyshort2 copyshort3 copyshortTrust200811 \
           ...
           copyshortPlaygroundSpring201604
    global funding funding1 funding2
    global backP
    ...
    ## Added by SJN
    if {![string compare $attrs(ipr) "playgroundSpring201604"]} {
    	set copyshort $copyshortPlaygroundSpring201604
    }
    ### END ADD ###
...
set copyshortPlaygroundSpring201604 \
{"Copyright (c) %YEAR% SETH JAMES NIELSON. All rights reserved."
...
"Playground-Drafts are working documents of the PLAYGROUND experiment
conducted by Seth James Nielson for pedigogical purposes.
Note that, as part of the experiment, other groups may contribute
Playground-Drafts. This includes students comprising Playground Engineering
Task Forces."

"Playground-Drafts are pedigogical documents valid for a maximum of six months
or a single school semester if used in an academic context. These drafts
may be updated, replaced, or obsoleted by other documents at any time.
It is inappropriate to use Playground-Drafts as reference material outside
of an associated PLAYGROUND experiment or to cite
them other than as &ldquo;PLAYGROUND EXPERIMENTAL.&rdquo;"
...
"This Playground-Draft will expire on %EXPIRES%."
}
