...
than English."}
		...
		{playgroundWinter2014
"This Playground-Draft is submitted for pedagogical purposes.
Further copyright information will be inserted here."}
...
proc front_txt_begin {left right top bottom title keywords lang} {
    ...
    set blankP 1
    set eatP 0
# puts stderr "front_txt_begin eatP<=$eatP"
...
proc t_txt {tag counter style hangText editNo} {
    ...
    global eatP
    global mode
# puts stderr "[get_current_function_name] eatP==$eatP"
...
proc two_spaces {glop {flatten 0}} {
    ...
    set foo "x$glop"
# puts stderr "two_spaces: glop=$glop"
    if {$flatten} {
        set post ""
        set glop [string trim $glop]
        regsub -all -- {[\t\n ]+} $glop { } glop
# puts stderr "two_spaces:f glop=>$glop"
    } else {
